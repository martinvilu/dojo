                ...
                {isRegistering ? (
                  <p>
                    ...
                    <button
                      ...
                      className="text-blue-400 hover:underline font-bold bg-transparent border-none p-0 cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 focus-visible:rounded"
                    >
                      Iniciá sesión
                    </button>
                  </p>
