            ...
            <div className="w-full bg-neutral-900/90 backdrop-blur-2xl border border-neutral-800 p-6 sm:p-8 rounded-3xl shadow-2xl relative z-10 text-left">
              ...
              <div className="grid grid-cols-2 gap-3 w-full">
                <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center space-x-2 bg-neutral-950 hover:bg-neutral-800 border border-neutral-800 rounded-xl py-2.5 transition text-xs font-medium text-white cursor-pointer disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 focus-visible:ring-offset-neutral-900"
                >
