            ...
            <div className="w-full bg-neutral-900/90 backdrop-blur-2xl border border-neutral-800 p-6 sm:p-8 rounded-3xl shadow-2xl relative z-10 text-left">
              ...
              <form onSubmit={handleEmailAuth} className="space-y-4 w-full">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full bg-neutral-950 border border-neutral-800 rounded-xl px-4 py-2.5 pr-10 text-xs sm:text-sm focus:outline-none focus:border-blue-500 transition text-white font-mono"
                      required
                    />
                    <button
                      type="button"
                      ...
                      className="absolute inset-y-0 right-0 flex items-center pr-3 text-neutral-500 hover:text-neutral-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 rounded-xl cursor-pointer"
                    >
                      {showPassword ? (
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-blue-600 hover:bg-blue-500 active:bg-blue-700 transition text-white font-bold py-3 rounded-xl shadow-lg shadow-blue-500/20 flex items-center justify-center space-x-2 text-xs sm:text-sm disabled:opacity-50 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 focus-visible:ring-offset-[#0a0a0a]"
                >
                  {loading ? (
              ...
              <div className="grid grid-cols-2 gap-3 w-full">
                <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center space-x-2 bg-neutral-950 hover:bg-neutral-800 border border-neutral-800 rounded-xl py-2.5 transition text-xs font-medium text-white cursor-pointer disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 focus-visible:ring-offset-[#0a0a0a]"
                >
                ...
                {isRegistering ? (
                  <p>
                    ...
                    <button
                      ...
                      className="text-blue-400 hover:underline font-bold bg-transparent border-none p-0 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 focus-visible:ring-offset-[#0a0a0a] rounded"
                    >
                      Iniciá sesión
                    </button>
                  </p>
