...
const fullDateFormatter = new Intl.DateTimeFormat("es-AR", { dateStyle: 'short', timeStyle: 'medium' });
                  ...
                  <div className="space-y-2">
                    {scheduleVersions.map((v) => (
                      ...
                      >
                        ...
                        <p className="text-[9px] text-gray-500">{fullDateFormatter.format(new Date(v.created_at))}</p>
