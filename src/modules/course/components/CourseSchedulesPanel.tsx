...
// ⚡ Bolt Optimization: Pre-instantiate DateTimeFormat for better performance in map loops
const fullDateFormatter = new Intl.DateTimeFormat("es-AR", { weekday: "long", day: "numeric", month: "long", timeZone: "UTC" });
...
const longShortDateFormatter = new Intl.DateTimeFormat("es-AR", { weekday: "long", day: "numeric", month: "short", timeZone: "UTC" });
                  ...
                  <div className="space-y-6">
                    ...
                    {scheduleViewMode === "list" ? (
                      <div className="space-y-4">
                        ...
                        const dateStr = fullDateFormatter.format(dateObj);
                        ...
                        <div key={weekNum} className="border border-neutral-800 bg-neutral-900/20 p-6 rounded-2xl space-y-4">
                          ...
                          <div className="space-y-3">
                            {weeklyClassesGrouped[parseInt(weekNum)].map((ci: any, index: number) => {
                                  ...
                                  const ds = longShortDateFormatter.format(d);
