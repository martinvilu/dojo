...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#0a0a0a] text-white p-4 sm:p-6 overflow-x-hidden">
      ...
      <div className="w-full max-w-md min-w-[280px] sm:min-w-[380px] bg-neutral-900/80 backdrop-blur-xl border border-neutral-800 p-6 sm:p-8 rounded-2xl shadow-2xl relative z-10 shrink-0 mx-auto">
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-950/50 border border-red-800/80 rounded-xl text-red-400 text-xs sm:text-sm break-words">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4 w-full">
          <div className="w-full">
            ...
            <input
              ...
              className="w-full min-w-full bg-neutral-950/80 border border-neutral-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition text-white"
              required
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full min-w-full bg-blue-600 hover:bg-blue-500 active:bg-blue-700 transition text-white font-medium py-3 rounded-xl shadow-lg shadow-blue-500/20 flex items-center justify-center space-x-2 text-sm disabled:opacity-55 cursor-pointer"
          >
            {loading ? (
        ...
        <div className="relative my-8 w-full">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-neutral-900 px-3 text-gray-500 backdrop-blur-xl">O continuar con</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center space-x-2 bg-neutral-950/80 hover:bg-neutral-800 border border-neutral-800 rounded-xl py-2.5 transition text-sm cursor-pointer disabled:opacity-50"
          >
