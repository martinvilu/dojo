...
1.  **OMAE WA CLASSROOM**: 
    *   **Referencia**: "Omae wa mou shindeiru" (*Fist of the North Star*).
    *   **Contexto**: Ideal para cuando un estudiante se da cuenta de que la fecha de bloqueo (`lock_date`) ya pasó. "Ya estás desaprobado".
2.  **SHINRA TENENSEI (Asistencia Divina)**:
    *   **Referencia**: El ataque de Pain en *Naruto*.
    *   **Contexto**: El profesor "empuja" el conocimiento y atrae la asistencia con el QR dinámico.
3.  **PLUS ULTRA ACADEMY**:
    *   **Referencia**: El lema de *My Hero Academia*.
    *   **Contexto**: Para un sistema que va más allá de un simple repositorio, integrando todo el ciclo académico.
4.  **DEATH NOTEBOOK**:
    *   **Referencia**: *Death Note*.
    *   **Contexto**: La lista de alumnos donde el profesor anota quién entregó y quién no. Si tu nombre está ahí con un ❌ (Rehacer), "estás fuera".
5.  **BANKAI REPO**:
    *   **Referencia**: Liberación de poder en *Bleach*.
    *   **Contexto**: Cuando el estudiante finalmente hace el "Submit" y libera su código final al profesor.

## 🎬 Nombres de Películas de Acción

1.  **JOHN WICK'S PENCIL**:
    *   **Referencia**: La leyenda de que John Wick mató a tres hombres con un lápiz.
    *   **Contexto**: Representa la eficiencia letal del sistema. "Hacer mucho con herramientas simples" (Supabase + Vanilla JS).
2.  **MISSION IMPOSSIBLE: DEADLINE**:
    *   **Referencia**: La saga de Tom Cruise.
    *   **Contexto**: El dashboard del estudiante con los temporizadores del QR y las fechas límite. "Este mensaje se autodestruirá (se pondrá en solo lectura) en 10 segundos".
3.  **THE EXPENDABLES (La Roster)**:
    *   **Referencia**: *Los Indestructibles*.
    *   **Contexto**: El listado de alumnos (`course_roster`) listos para la misión de aprobar la asignatura.
4.  **TERMINATOR: JUDGMENT DAY**:
    *   **Referencia**: *Terminator 2*.
    *   **Contexto**: El día de la corrección final. "I'll be back... con correcciones".
5.  **DIE HARD REPO**:
