...
# Add to Navbar
nav_match = r'<a href="/teacher/assignments" class="nav-item">Entregas</a>'
html = re.sub(nav_match, '<a href="/teacher/assignments" class="nav-item">Entregas</a>\n            <a href="/teacher/announcements" class="nav-item">Avisos</a>', html)

# Add Section
section_html = """
        <div id="teacher-announcements" class="content-section hidden">
...
# Insert before student-courses section
html = html.replace('<div id="student-courses" class="content-section hidden">', section_html + '\n        <div id="student-courses" class="content-section hidden">')
